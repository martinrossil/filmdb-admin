...
export default class PersonsCard extends TitleCard {
    public constructor() {
        super('Persons');
        this.updateTotalValue();
        this.addComponent(this.totalLabel);
        Model.personsCount.addEventListener(ObservableNumber.CHANGED, this.updateTotalValue.bind(this));
    }

    private updateTotalValue(): void {
        this.totalLabel.text = Model.personsCount.value + '';
    }
...
customElements.define('persons-card', PersonsCard);
